...
Constants:
  ...
  - CB_OC_PREFIX: OpenCode shortcut commands from inline keyboard
  - CB_SHORTCUT_SCREENSHOT: Capture screenshot from shortcut panel
...
# Shortcut panel
CB_OC_PREFIX = "oc:"  # oc:<command>:<window>
CB_SHORTCUT_SCREENSHOT = "sc:ss:"  # sc:ss:<window>
